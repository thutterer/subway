import{a as e,c as t,l as n,n as r}from"./index-BkHQ0ExB.js";import"./back-link-B-L5DXZP.js";var i=class extends e{constructor(...e){super(...e),this.options=[],this.value=``}static{this.properties={options:{type:Array},value:{type:String}}}_onSelect(e){this.value=e,this.dispatchEvent(new CustomEvent(`tile-select`,{detail:{value:e},bubbles:!0,composed:!0}))}static{this.styles=n`
  ...
  `}render(){return t`
    ...
    `}};customElements.define(`tile-select`,i);var a=t`<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M16 4h-2v6h6V8h2v14H2V2h14v2ZM4 20h16v-8h-8V4H4v16Zm8-2H6v-2h6v2Zm-2-4H6v-2h4v2Zm10-6h-2V6h2v2Zm-2-2h-2V4h2v2Z"/></svg>`,o=t`<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M10 5h12v2H10zm0 4h8v2h-8zm0 4h12v2H10zm0 4h8v2h-8zM4 7v2h2V7H4Zm4 4H2V5h6v6Zm-6 2h6v2H2zm0 4h6v2H2zm0 0v-2h2v2zm4 0v-2h2v2z"/></svg>`,s=[{value:`text`,label:`Note`,icon:a},{value:`list`,label:`List`,icon:o}],c=class extends e{static{this.styles=n`
    .header {
      display: flex;
      align-items: center;
      gap: 0.5rem;
